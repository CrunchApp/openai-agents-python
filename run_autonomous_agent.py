...
def main() -> None:
    ...
    try:
        ...
        # Schedule the main autonomous loop (30 minutes for close monitoring)
        logger.info("⏰ Scheduling autonomous decision-making cycle (30-minute intervals)...")
        scheduling_agent.schedule_autonomous_cycle(interval_minutes=30)
        logger.info("✅ Autonomous cycle scheduled (every 30 minutes)")
        ...
        logger.info("  • Autonomous Decision Cycle: Every 30 minutes")
        ...
        logger.info("🔄 Next autonomous decision cycle will begin in 30 minutes...")
